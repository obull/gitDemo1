...
public class AutomationLibrary {
	...
	public void assertion_Tally(By by, String value) {
        try {
            WebElement totalCost = driver.findElement(by);
            String totalPaying = totalCost.getText(); // this method grabbing
            // text from in between tags.
            // String monthlyPaymentText = summaryMonthly.getAttribute("value"); // this
            // method grabbing attribute name
            // 'value'
            System.out.println("Total Pay Amount And Duration: " + totalPaying);
            assertEquals(totalPaying, value);
